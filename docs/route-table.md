...
| POST | `/api/feed/batch` | `feedReader#getFeedBatch` | any logged-in user | exempt |
...
| POST | `/api/share/{token}/feed/batch` | `publicShare#getFeedBatchByShare` | anonymous | exempt |
