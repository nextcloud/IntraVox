...
# IntraVox Deployment Script (NO SETUP)
# Use this when you want to preserve existing data (e.g., after import)
# Deploys to Nextcloud test server without running setup
...
APP_NAME="intravox"
REMOTE_USER="rdekker"
REMOTE_HOST="145.38.188.218"  # 3dev server
...
echo "🚀 IntraVox Deployment Script (NO SETUP)"
echo "=========================================="
echo "📌 Version: $VERSION"
echo "📅 Date: $(date '+%Y-%m-%d %H:%M:%S')"
echo ""
echo "⚠️  This script will NOT run setup or import demo data"
echo "    Use this to preserve existing data after import"
...
echo ""
echo "🔧 Step 4: Enabling app (WITHOUT setup)..."
ssh -i "$SSH_KEY" "${REMOTE_USER}@${REMOTE_HOST}" << EOF
    set -e
...
echo "  • Server: $REMOTE_HOST"
echo "  • Status: Deployed and enabled (NO SETUP RUN)"
echo ""
echo "⚠️  Important Notes:"
echo "  • Setup was NOT run - existing data preserved"
echo "  • If this is a fresh install, run: ssh ${REMOTE_USER}@${REMOTE_HOST} 'sudo -u www-data php occ intravox:setup'"
echo "  • If you imported data, it should still be intact"
echo ""
