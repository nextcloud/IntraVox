...
class PageServicePublicSurfaceTest extends TestCase {
    ...
    private const PUBLIC_SURFACE = [
        ...
        'deletePage' => 1,
        'deleteTemplate' => 1,
        'effectivePublishState' => 2,
        'endDeferredClear' => 0,
        'getBreadcrumb' => 1,
        'getCurrentPageContent' => 1,
        'getFolderPermissions' => 1,
        ...
        'getPageTree' => 3,
        'getPageVersions' => 1,
        'getResourcesMediaFile' => 1,
        'getTemplate' => 1,
        'getTranslatableLanguages' => 1,
        'getTranslationCandidates' => 2,
        'getUploadLimit' => 0,
        'getVersionContent' => 2,
        'hasPublicationDate' => 2,
        'invalidateAllCaches' => 0,
        'isHiddenFromReaders' => 2,
        'isHomepage' => 2,
        'linkTranslation' => 2,
        'listPages' => 0,
        'listPagesWithContent' => 0,
        'listTemplates' => 0,
        'movePage' => 2,
        'pageExistsByUniqueId' => 1,
        'publicationMetaForFiles' => 1,
        'rebuildIndex' => 1,
        'reorderSiblings' => 2,
        'repairEntities' => 1,
