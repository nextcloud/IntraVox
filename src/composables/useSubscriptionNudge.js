 ...
 *
 * Nothing here is a limit. IntraVox behaves identically above and below the
...
export function subscriptionNudge(stats) {
	...
	if (stats.hasValidSubscription || stats.hasExtendedSupport) {
		return t('intravox', 'Nextcloud Enterprise subscription detected on this instance. IntraVox subscriptions are sold through Nextcloud — contact your Nextcloud account manager or sales@nextcloud.com.')
	}
	...
	return t('intravox', 'IntraVox is running for {count} users here and keeps working in full without a subscription. If your organisation gets value from it, a subscription is much appreciated — it funds the maintenance. Sold through Nextcloud: contact your account manager or sales@nextcloud.com.', { count: users })
}
