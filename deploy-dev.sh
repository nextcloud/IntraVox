...
# IntraVox Development Server Deployment Script
# Deploys to Nextcloud dev server (145.38.191.66)

set -e

echo "🚀 IntraVox Development Deployment Script"
echo "=========================================="

# Configuration
APP_NAME="intravox"
REMOTE_USER="rdekker"
REMOTE_HOST="145.38.191.66"  # Development server
...
echo ""
echo "🚢 Step 3: Deploying to development server..."
...
echo "  • Server: $REMOTE_HOST (Development)"
echo "  • Status: Deployed and enabled"
echo ""
echo "🌐 Access IntraVox at:"
echo "  https://intravoxdev.hvanextcloudpoc.src.surf-hosted.nl"
echo ""
echo "📝 Next steps:"
echo "  • Deploy demo data: ./deploy-demo-data.sh"
echo ""
