...
**Truly Collaborative** - Uses shared folders so everyone on your team sees the same content, in real-time.
...
**Beautifully Integrated** - Lives right in your Nextcloud interface.
...
When released, IntraVox will require:
